package com.mgp.datasource.beans;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "mysql.datasource.mysqlone")
public class DBConfigOne {
	...
	public String toString() {
		return "DBConfigOne [url=" + url + ", username=" + username + ", password=" + password + ", minPoolSize="
